...
export default function CommunityCTA() {
  return (
    <section className="w-full flex flex-col items-center justify-center py-8 px-4">
      <div className="bg-gradient-to-br from-pink-400 via-purple-500 to-cyan-400 rounded-2xl shadow-elegant p-4 max-w-md w-full flex flex-col items-center text-center">
