    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="relative">
          <div className="h-64 bg-gradient-to-br from-pink-400 to-pink-500 relative">
            ...
            <div className="absolute bottom-6 left-6 right-6 text-white">
              ...
              <p className="text-pink-100 text-lg">{event.societyName}</p>
            </div>
          </div>
        </div>
            ...
            {event.requiresOrganizerSignup && event.organizerEmail && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${event.organizerEmail}`} className="text-pink-600 hover:text-pink-700 text-sm">
              ...
              <div className="text-center py-6">
                ...
                {event.requiresOrganizerSignup && event.organizerEmail && (
                  <a
                    ...
                    className="mt-4 bg-pink-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-pink-700 transition-colors inline-block"
                  >
                    Contact Organizer
                  </a>
                )}
