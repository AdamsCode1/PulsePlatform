  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <NavBar />
        <LoadingSpinner variant="page" size="lg" text="Loading your deals..." />
      </div>
    );
  }
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            View and manage your student deals and promotions.
          </p>
        </div>
        ...
        <Card>
          <CardContent className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              This feature will allow partner organizations to submit and manage exclusive deals for students.
            </p>
